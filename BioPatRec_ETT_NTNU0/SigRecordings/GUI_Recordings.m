...
% Last Modified by GUIDE v2.5 04-Apr-2013 13:12:39
...
function pb_StartRecording_Callback(hObject, eventdata, handles)
    ...
    cdata = TrignoSession4(handles,sCh,sF,sT,pT);
end
...
% --- Executes on button press in trigno.
function trigno_Callback(hObject, eventdata, handles)
% hObject    handle to trigno (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of trigno
