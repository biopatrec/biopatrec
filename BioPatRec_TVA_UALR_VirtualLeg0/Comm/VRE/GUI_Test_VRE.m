...
% Last Modified by GUIDE v2.5 15-Jul-2014 12:52:49
...
retval22=fread(obj,1)

fwrite(obj,sprintf('%c%c%c%c%c',checkValues(one),checkValues(two),checkValues(three),0,0));

retval=fread(obj,1)
toc
set(handles.et_retval,'String',retval);
