...
%%%%%%%%%%%%%%Code evaluating space begins
% handles
% handles.patRecHandles
% handles.patRecHandles.patRec
% handles.patRecHandles.patRec.patRecTrained
% handles.patRecHandles.patRec.patRecTrained.accV

%pR=guidata(handles.mainGUI) %checking code taimoor afzal 3/10/2015
%pause %checking code taimoor afzal 3/10/2015
%%%%%%%%%%%%%%code evaluating space ends
